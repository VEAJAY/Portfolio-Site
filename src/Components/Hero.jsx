...
function Hero() {
    return (
        <div className="flex flex-col min-h-screen justify-center items-center text-white p-4 dark:bg-gray-200">
            {/* NAME */}
            <h1 className="border-gray-400 border-b pb-4 mb-6 text-xl sm:text-md md:text-lg lg:text-xl text-center dark:text-black">
                Hello! 👋 I&apos;m Jayland Veasey!
            </h1>

            {/* MAIN HEADING */}
            <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-center leading-tight sm:leading-none w-full lg:w-[90rem] dark:text-black">
            ...
            <div className="my-6 p-4 bg-slate-800 dark:bg-slate-300 rounded-2xl font-mono text-sm sm:text-base">
                <p className="text-gray-300 text-center dark:text-black">
            ...
            <div className="flex flex-col sm:flex-row gap-4 m-4">
                ...
                <button className="flex items-center justify-center py-3 px-8 border rounded-full font-bold gap-2 hover:bg-white hover:text-gray-900 duration-300 w-full sm:w-auto dark:border-black dark:text-black dark:hover:bg-black dark:hover:text-gray-200">
                    Contact
