      ...
      <div className="flex justify-center items-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-12">
          ...
          <ExperienceCard
            ...
            employer="Heroes & Sober Living"
            date="August 2025 - Current"
            paragraph="During my time at Heores & Sober Living, I had the ooportunity to develop and maintain their first website for group home veterans and recovering community members, as well as managing all social media and online presence to effectively reach out to those needing new homes."
            activities={[
              "Developed a clean, easy-to-use website for older communities in an effort to help them find new homes",
              "Managed all social media presence for the company i.e. Facebook & Instagram",
